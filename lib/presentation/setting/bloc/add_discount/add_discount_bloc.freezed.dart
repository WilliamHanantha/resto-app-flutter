...
class __$$DeleteDiscountImplCopyWithImpl<$Res>
    extends _$AddDiscountEventCopyWithImpl<$Res, _$DeleteDiscountImpl>
...
class _$DeleteDiscountImpl implements _DeleteDiscount {
  const _$DeleteDiscountImpl({required this.id});
  ...
  @override
  String toString() {
    return 'AddDiscountEvent.deleteDiscount(id: $id)';
  }
...
abstract class _DeleteDiscount implements AddDiscountEvent {
  const factory _DeleteDiscount({required final int id}) = _$DeleteDiscountImpl;
