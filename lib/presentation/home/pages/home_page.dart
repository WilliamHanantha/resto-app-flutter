...
import 'package:resto_app/presentation/home/pages/confirm_payment_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void fillSearchResult(List<Product> data) {
    // setState(() {
    searchResults = data;
    // });
  }
                                      ...
                                      if (searchController.text.isNotEmpty &&
                                        ...
                                        return GridView.builder(
                                          ...
                                          itemBuilder: (context, index) =>
                                              ProductCard(
                                            data: searchResults.toList()[index],
                                            onCartButton: () {},
                                          ),
                                        );
